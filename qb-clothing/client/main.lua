...
AddEventHandler('qb-clothing:client:loadPlayerClothing', function(data, ped)
    ...
    if not data["facemix"] or not data["face2"] then
        ...
        data["face"] = skinData["face"]
        data["pants"] = skinData["pants"]
        data["hair"] = skinData["hair"]
        data["eyebrows"] = skinData["eyebrows"]
        data["beard"] = skinData["beard"]
        data["blush"] = skinData["blush"]
        data["lipstick"] = skinData["lipstick"]
        data["makeup"] = skinData["makeup"]
        data["ageing"] = skinData["ageing"]
        data["arms"] = skinData["arms"]
        data["t-shirt"] = skinData["t-shirt"]
        data["vest"] = skinData["vest"]
        data["torso2"] = skinData["torso2"]
        data["shoes"] = skinData["shoes"]
        data["mask"] = skinData["mask"]
        data["decals"] = skinData["decals"]
        data["accessory"] = skinData["accessory"]
        data["bag"] = skinData["bag"]
        data["hat"] = skinData["hat"]
        data["glass"] = skinData["glass"]
        data["ear"] = skinData["ear"]
        data["watch"] = skinData["watch"]
        data["bracelet"] = skinData["bracelet"]
        data["eye_color"] = skinData["eye_color"]
        data["moles"] = skinData["moles"]
        data["nose_0"] = skinData["nose_0"]
        data["nose_1"]   = skinData["nose_1"]
        data["nose_2"]   = skinData["nose_2"]
        data["nose_3"]   = skinData["nose_3"]
        data["nose_4"]   = skinData["nose_4"]
        data["nose_5"]   = skinData["nose_5"]
        data["cheek_1"]   = skinData["cheek_1"]
        data["cheek_2"]   = skinData["cheek_2"]
        data["cheek_3"]   = skinData["cheek_3"]
        data["eyebrown_high"]   = skinData["eyebrown_high"]
        data["eyebrown_forward"]   = skinData["eyebrown_forward"]
        data["eye_opening"]   = skinData["eye_opening"]
        data['lips_thickness'] = skinData["lips_thickness"]
        data['jaw_bone_width'] = skinData["jaw_bone_width"]
        data['jaw_bone_back_lenght'] = skinData["jaw_bone_back_lenght"]
        data['chimp_bone_lowering'] = skinData["chimp_bone_lowering"]
        data['chimp_bone_lenght'] = skinData["chimp_bone_lenght"]
        data['chimp_bone_width'] = skinData["chimp_bone_width"]
        data['chimp_hole'] = skinData["chimp_hole"]
        data['neck_thikness'] = skinData["neck_thikness"]
    end
