RegisterNetEvent('sgx-chopshop:wheelanimation')
AddEventHandler('sgx-chopshop:wheelanimation', function()
...
RegisterNetEvent('sgx-chopshop:dooranimation')
AddEventHandler('sgx-chopshop:dooranimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('sgx-chopshop:trunkanimation')
AddEventHandler('sgx-chopshop:trunkanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('sgx-chopshop:hoodanimation')
AddEventHandler('sgx-chopshop:hoodanimation', function()
	local ped = PlayerPedId()
...
RegisterNetEvent('sgx-chopshop:wheelchopanim')
AddEventHandler('sgx-chopshop:wheelchopanim', function()
	local ped = PlayerPedId()
	...
	exports["sgx-emotemenu"]:EmoteCommandStart("weld")
	Citizen.Wait(12000)
	ClearPedTasks(ped)
...
RegisterNetEvent('sgx-chopshop:doorchopanim')
AddEventHandler('sgx-chopshop:doorchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('sgx-chopshop:hoodchopanim')
AddEventHandler('sgx-chopshop:hoodchopanim', function()
	local ped = PlayerPedId()    
...
RegisterNetEvent('sgx-chopshop:trunkchopanim')
AddEventHandler('sgx-chopshop:trunkchopanim', function()
	local ped = PlayerPedId()
