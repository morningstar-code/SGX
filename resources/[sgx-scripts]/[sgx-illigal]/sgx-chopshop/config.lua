...
Config.Email = false -- The sent number plate comes to your phone as an e-mail. If you are going to use SGX UI, make it false.

Config.Fuel = 'sgx-fuel'

Config.StartLoc = vector4(0, 0, 0, 0)  -- Starting Location with target and PED
