        ...
        QBCore.Functions.TriggerCallback("qb-methrun:server:coolc",function(isCooldown)
            if not isCooldown then
                ...
                QBCore.Functions.Progressbar("start_job", Lang:t('info.talking_to_boss'), 10000, false, true, {
                    ...
                    TriggerServerEvent('qb-logs:server:createLog', 'Randi', 'Player Start/Found The Drug Mission Of Randi', "", src)
...
function spawncase()
    local case = CreateObject(`prop_security_case_01`, 3866.97, 4463.72, 1.73, true,  true, true)
    CreateObject(case)
    ...
    QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result)
        if result then
            ...
            exports['sgx-skillchecks']:untangle(function (result)
                exports["sgx-emotemenu"]:EmoteCommandStart("type3")
                QBCore.Functions.Progressbar("grab_case", Lang:t('info.unlocking_case'), 10000, false, false, {
                    disableMovement = true,
                    disableCarMovement = true,
                    disableMouse = false,
                    disableCombat = true,
            ...
            end,"DrugCase", "Untangle Ropes On Suitcase!", 20000, 6,
