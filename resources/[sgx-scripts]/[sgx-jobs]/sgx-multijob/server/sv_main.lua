...
QBCore.Functions.CreateCallback("multijob:getJobs", function(source, cb)
...
RegisterNetEvent("multijob:changeJob",function(cjob, cgrade)
    local source = source
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("multijob:removeJob",function(job, grade)
    local source = source
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent('multijob:server:removeJob', function(targetCitizenId)
