...
Config.Deliver = {min = 16, max = 32} -- How many garbage bags per location?
Config.MaxDeliver = 32 -- How many MAXIMUM garbage bags per location?
Config.MaterialCheck = 16 -- How many trash bags each person MUST turning in to recieve a ticket 8 = 1 ticket, scales with group so if its a 3 man group they need to turn in 24 and they will all recieve 1 ticket
