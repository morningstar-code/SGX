			...
			if k == "beangabzlegion" then
				Targets["BeanWash"] =
					exports['qb-target']:AddBoxZone("BeanWash", vector3(-1200.351, -1139.322, 7.8332743), 1.2, 0.8, { name="BeanWash", heading = 340.0, debugPoly=Config.Debug, minZ=6.88, maxZ=8.68 },
						{ options = { { event = "qb-coolbeans:washHands", icon = "fas fa-hand-holding-water", label = Loc[Config.Lan].targetinfo["wash_hands"], job = v.job, coords = vec3(0, 0, 0) }, }, distance = 1.5 })
						Targets["BeanWash"] =
				...
				Targets["BeanCounter"] =
					exports['qb-target']:AddBoxZone("BeanCounter", vector3(-1198.897, -1135.957, 7.4023761), 0.7, 1.2, { name="BeanCounter", heading = 340.0, debugPoly=Config.Debug, minZ=6.4, maxZ=8.48 },
						{ options = { { event = "qb-coolbeans:Stash", icon = "fas fa-mug-saucer", label = Loc[Config.Lan].targetinfo["open_counter"], stash = "Counter", coords = vec3(0, 0, 0) }, }, distance = 2.0 })
				...
				-- 		{ options = { { event = "sgx-payments:client:Charge", icon = "fas fa-credit-card", label = Loc[Config.Lan].targetinfo["charge_customer"], job = v.job,
				...
				Targets["BeanFridge"] =
					exports['qb-target']:AddBoxZone("BeanFridge", vector3(-1196.879, -1141.817, 8.1863431), 0.85, 0.6, { name="BeanFridge", heading = 340.0, debugPoly=Config.Debug, minZ=7.1863431, maxZ=9.1863431 },
						{ options = { {  event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_storage"], job = v.job, shop = Config.FoodItems, shopname = "BeanFridge", coords = vec3(0, 0, 0) }, }, distance = 1.5 })
				-- Targets["BeanFridge2"] =
				...
				Targets["BeanDrink"] =
					exports['qb-target']:AddBoxZone("BeanDrink", vector3(-1195.964, -1143.115, 8.1658587), 0.86, 0.8, { name="BeanDrink", heading = 340.0, debugPoly=Config.Debug, minZ=7.1658587, maxZ=9.1658587 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-mug-hot", label = Loc[Config.Lan].targetinfo["prepare_coffee"], job = v.job, craftable = Crafting.Drinks, header = Loc[Config.Lan].menu["drink_menu"], coords = vec3(0, 0, 0) }, }, distance = 2.0 })
				-- Targets["BeanDrink2"] =
				...
				Targets["BeanSlush"] =x
					exports['qb-target']:AddBoxZone("BeanSlush", vector3(-1201.052, -1146.169, 8.3249688), 0.8, 0.8, { name="BeanSlush", heading = 340.0, debugPoly=Config.Debug, minZ=7.3249688, maxZ=9.3249688 },
						{ options = { { event = "qb-coolbeans:Crafting", icon = "fas fa-cocktail", label = Loc[Config.Lan].targetinfo["prepare_slush"], job = v.job, craftable = Crafting.Slush, header = Loc[Config.Lan].menu["slush_menu"], coords = vec3(0, 0, 0) }, }, distance = 2.0 })
				...
				Targets["BeanSoda"] =
					exports['qb-target']:AddBoxZone("BeanSoda", vector3(-1198.729, -1138.396, 7.8332571), 1.3, 1.4, { name="BeanSoda", heading = 340.0, debugPoly=Config.Debug, minZ=6.7, maxZ=8.8 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["grab_soda"], job = v.job, shop = Config.SodaItems, shopname = "BeanSoda", coords = vec3(0, 0, 0) }, }, distance = 2.0 })
				...
				Targets["donut"] =
					exports['qb-target']:AddBoxZone("donut", vector3(-1202.291, -1138.176, 7.8332724), 1.45, 0.9, { name="donut", heading = 340.0, debugPoly=Config.Debug, minZ=6.7, maxZ=8.8 },
						{ options = { { event = "qb-coolbeans:Shop", icon = "fas fa-circle-dot", label = Loc[Config.Lan].targetinfo["grab_food"], job = v.job, shop = Config.DesertItems, shopname = "donut", coords = vec3(0, 0, 0) },
									{ event = "qb-coolbeans:Stash", icon = "fas fa-archive", label = Loc[Config.Lan].targetinfo["open_stash"], job = v.job, stash = "LegionStash", coords = vec3(0, 0, 0) }, }, distance = 2.0 })
