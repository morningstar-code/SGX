	...
	const debugActions = [
		...
		},
		{
			...
			dropdown: [
				...
				{ label: "Ban", type: "server", option: "button", event: "sgx-adminmenu:client:banplayer" },
			],
		},
		{
			id: "noclip",
			...
			type: "client",
			perms: "mod",
			event: "sgx-adminmenu:client:noclip",
		},
		{
			id: "invisible",
			label: "Invisible",
			type: "client",
			perms: "mod",
			event: "sgx-adminmenu:client:invisible",
		},
		{
			id: "kick_player",
			label: "Kick Player",
			type: "client",
			perms: "mod",
			event: "sgx-adminmenu:client:kickplayer",
			dropdown: [
				{ label: "Player", option: "dropdown", data: "players" },
				{ label: "Reason", option: "text" },
				{ label: "Time", option: "dropdown", 
