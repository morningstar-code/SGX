...
lib.callback.register('sgx-adminmenu:callback:GetResources', function(source)
...
lib.callback.register('sgx-adminmenu:callback:ChangeResourceState', function(source, data, perms)
