...
lib.callback.register('sgx-adminmenu:callback:CheckPerms', function(source, perms)
    return CheckPerms(source, perms)
end)

lib.callback.register('sgx-adminmenu:callback:CheckAlreadyPlate', function(_, vPlate)
