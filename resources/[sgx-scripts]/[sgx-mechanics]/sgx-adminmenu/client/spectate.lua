...
RegisterNetEvent('sgx-adminmenu:requestSpectate', function(targetPed, target, name)
...
RegisterNetEvent('sgx-adminmenu:cancelSpectate', function()
    ...
    while true do
        ...
        if spectateInfo['toggled'] then
            ...
            if DoesEntityExist(targetPed) then
                ...
                TriggerServerEvent('sgx-adminmenu:spectate:teleport', spectateInfo['target'])
