local function getMessagesCallBack()
	return lib.callback.await('sgx-adminmenu:callback:GetMessages', false)
end
...
RegisterNUICallback("SendMessage", function(msgData, cb)
	...
	TriggerServerEvent("sgx-adminmenu:server:sendMessageServer", message, PlayerData.citizenid, PlayerData.charinfo.firstname .. " " .. PlayerData.charinfo.lastname)
