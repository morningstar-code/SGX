-- Set on fire
RegisterNetEvent('sgx-adminmenu:client:SetOnFire', function(time)
...
-- Explode player
RegisterNetEvent('sgx-adminmenu:client:ExplodePlayer', function(damage)
...
-- Play Sound
RegisterNetEvent('sgx-adminmenu:client:PlaySound', function(data, selectedData)
...
-- Drunk Player
RegisterNetEvent('sgx-adminmenu:client:InitiateDrunkEffect', function()
