-- Changes the time
RegisterNetEvent('sgx-adminmenu:client:ChangeTime', function(data, selectedData)
...
-- Changes the weather
RegisterNetEvent('sgx-adminmenu:client:ChangeWeather', function(data, selectedData)
    local data = CheckDataFromKey(data)
    if not data or not CheckPerms(data.perms) then return end
...
RegisterNetEvent('sgx-adminmenu:client:copyToClipboard', function(data, selectedData)
    local data = CheckDataFromKey(data)
    if not data or not CheckPerms(data.perms) then return end
