...
Config.CameraTimecycle = CAMERA_secuirity -- false or "string" ("Broken_camera_fuzz", "CAMERA_BW", "CAMERA_secuirity", "secret_camera" or any valid timecycle: https://wiki.rage.mp/index.php?title=Timecycle_Modifiers)
Config.CameraTimecycleStrength = 1.0 -- 0.0 to 1.0, the strngth of the camera timecycle, only used if Config.CameraTimecycle is set to a string.

Config.ShowLatitudeLongitude = true -- If set to true, it shows latitude/longitude, otherwise it shows the street and area
