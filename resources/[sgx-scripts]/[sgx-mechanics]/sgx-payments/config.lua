...
Config = {
	...
	Banking = "sgx-banking", 	
								...
								-- "sgx-banking" 	- This is for the latest QBCore updates
								-- "renewed"
    ...
    CustomCashRegisters = {
	    ["burgershot"] = { -- Player job role restriction
		 	{ coords = vector4(-1191.50, -894.22, 14.05, 260.99), prop = false, }, -- vector4 to place the till and the way it faces
		 	{ coords = vector4(-1193.41, -893.65, 14.05, 260.99), prop = false, }, -- "prop = true" spawns a prop at the coords
			{ coords = vector4(-1195.42, -893.15, 14.05, 260.99), prop = false, }, -- 
			{ coords = vector4(-1197.38, -892.48, 14.05, 260.99), prop = false, }, -- 
		},
		["coolbeans"] = { -- Player job role restriction
		{ coords = vector4(-1201.47, -1137.18, 7.90, 16.98), prop = false, }, -- vector4 to place the till and the way it faces
   },
	...
	BankBlips = false, -- Enable this if you disabled sgx-banking and need bank locations
