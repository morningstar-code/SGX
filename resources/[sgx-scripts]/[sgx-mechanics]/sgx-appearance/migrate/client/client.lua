...
RegisterNetEvent("sgx-appearance:client:migration:load-qb-clothing-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('sgx-appearance:client:migration:load-qb-clothing-clothes', playerSkin, PlayerPedId())
    end)
end)

RegisterNetEvent('sgx-appearance:client:migration:load-qb-clothing-clothes', function(playerSkin, ped)
    ...
    TriggerServerEvent("sgx-appearance:server:migrate-qb-clothing-skin", playerSkin.citizenid, appearance)
end)
