(function () {
  ...
  const tt = "" + new URL("discord.svg", import.meta.url).href;
  const nt = "" + new URL("store-d7be97ee.png", import.meta.url).href;
  const he = "" + new URL("logo-187456c5.png", import.meta.url).href;
  const pt = "" + new URL("youtube-7a39316a.svg", import.meta.url).href;
  const discord = "" + new URL("logo-187456c5.png", import.meta.url).href;
