...
Config.Objects = {
	[`sm_op_prop_chair_001b`] = { type = "sit", offsets = vector3(0.0, 0.0, 0.5), heading = 180.0},
    [`gr_prop_bunker_bed_01`] = { type = "lay", offsets = vector3(0.0, 0.0, 0.5), heading = 180.0},
	[`sm_op_prop_chair_002`]		= { type = "sit", offsets = vector3(0.0, 0.0, 0.5), heading = 180.0},
	[`sm_op_prop_pd_chairbench_01`]		= { type = "sit", offsets = vector3(0.0, 0.0, 0.5), heading = 180.0},
