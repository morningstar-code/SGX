<script lang="ts">
	...
	window.addEventListener('message', (event) => {
		...
		const placeholderStory = {
			id: 0,
			title: 'Welcome to sgx-newspaper',
			body: "<p>sgx-newspaper is a standalone ressource for FiveM. It has the following dependencies:</p><p><ul><li>qb-target</li><li>oxmysql</li></ul></p><p>I hope you'll enjoy the resource. Feel free to open issues if you find a bug/wish new functionality.</p><p>- sgx</p>",
