...
<p align="center">
    <a href="https://github.com/MaDHouSe79/sgx-cashasitem/issues">
        <img src="https://img.shields.io/github/issues/MaDHouSe79/sgx-cashasitem"/> 
    </a>
    <a href="https://github.com/MaDHouSe79/sgx-cashasitem/watchers">
        <img src="https://img.shields.io/github/watchers/MaDHouSe79/sgx-cashasitem"/> 
    </a> 
    <a href="https://github.com/MaDHouSe79/sgx-cashasitem/network/members">
        <img src="https://img.shields.io/github/forks/MaDHouSe79/sgx-cashasitem"/> 
    </a>  
    <a href="https://github.com/MaDHouSe79/sgx-cashasitem/stargazers">
        <img src="https://img.shields.io/github/stars/MaDHouSe79/sgx-cashasitem?color=white"/> 
    </a>
    <a href="https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/LICENSE">
        <img src="https://img.shields.io/github/license/MaDHouSe79/sgx-cashasitem?color=black"/> 
    </a>      
</p>
...
- for Exsisted user: Read the [UPDATE.MD](https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/update.md) if you have to change something.
...
# Optional
- [sgx-blackmarket](https://github.com/MaDHouSe79/sgx-blackmarket)
- [sgx-moneywash](https://github.com/MaDHouSe79/sgx-moneywash)

# Install
- Create a folder `[mh]` in resources,
- Put the folder `sgx-cashasitem` in the `[mh]` folder
...
- Read the [UPDATE.MD](https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/update.md)
...
TriggerEvent('sgx-cashasitem:server:updateCash', src, itemData, amount, "add", true) -- this true

-- true at the end of the trigger is to display money change at the right top of your screen
-- if false you don't see a change but it will change the money amount
TriggerEvent('sgx-cashasitem:server:updateCash', src, itemData, amount, "remove", true) -- this true
```
...
![alttext](https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/image/cash.png?raw=true)
![alttext](https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/image/black_money.png?raw=true)
![alttext](https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/image/crypto.png?raw=true)
...
```lua
-- it works but this is for sgx-stashes but this script is not released yet.
...
- [READ-ME](https://github.com/MaDHouSe79/sgx-cashasitem/blob/main/readme/)

# Contributers
<a href="https://github.com/MaDHouSe79/sgx-cashasitem/graphs/contributors">
  <img src="https://contributors-img.web.app/image?repo=MaDHouSe79/sgx-cashasitem" />
</a>
