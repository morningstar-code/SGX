...
# Installation
* Drag and drop `sgx-cryptomining`
* In your `server.cfg` add `ensure sgx-cryptomining`
...
[sgx-crypto-imgs](https://github.com/amsali22/sgx-crypto-imgs)
...
![imagffffe](https://github.com/planeklm/sgx-cryptomining/assets/91488137/ae69a460-e370-47e1-88ab-eef19a4e1e61)
