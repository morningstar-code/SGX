...
RegisterNetEvent('sgx-cryptomining:server:buyCryptoMiner', function()
    local src = source
    ...
    if Player.PlayerData.money.cash >= Config.Price['Stage 1'] then
        ...
        TriggerClientEvent('sgx-cryptomining:client:sendMail', src)
        ...
        TriggerClientEvent('sgx-cryptomining:client:addinfo', src, getData(Player.PlayerData.citizenid))
...
RegisterNetEvent('sgx-cryptomining:server:getinfo', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local data = getData(Player.PlayerData.citizenid)
    TriggerClientEvent('sgx-cryptomining:client:addinfo', src, data)
end)

QBCore.Functions.CreateCallback('sgx-cryptomining:server:showBalance', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('sgx-cryptomining:server:withdrawcrypto', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local data = getData(Player.PlayerData.citizenid)
...
RegisterNetEvent('sgx-cryptomining:server:switch',function(switchStatus)
...
QBCore.Functions.CreateCallback('sgx-cryptomining:server:showGPU', function(source, cb)
local src = source
local Player = QBCore.Functions.GetPlayer(src)
local PlayerCitizenID = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('sgx-cryptomining:server:checkGPUImage', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local PlayerCitizenID = Player.PlayerData.citizenid
    local image = 'Unkown'
...
RegisterNetEvent('sgx-cryptomining:server:sendGPUDatabase', function(gpu)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local PlayerCitizenID = Player.PlayerData.citizenid
    ...
    TriggerClientEvent('sgx-cryptomining:client:sendGPUMail', src)
end
end)

RegisterNetEvent('sgx-cryptomining:server:miningSystem', function()
local src = source
local Player = QBCore.Functions.GetPlayer(src)
local PlayerCitizenID = Player.PlayerData.citizenid
