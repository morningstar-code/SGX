...
Config.Locations = {
    ["HuntingZones"] = {
        [1] = {label = "Hunting Zone", radius = 550.0, coords = vector3(-973.44, 4424.14, 18.77)},
    },
    ["NoDispatchZones"] = {
        [1] = {label = "Ammunation 1", coords = vector3(13.53, -1097.92, 29.8), length = 30.0, width = 13.0, heading = 70, minZ = 28.8, maxZ = 32.8},
        [2] = {label = "Ammunation 2", coords = vector3(821.96, -2163.09, 29.62), length = 30.0, width = 13.0, heading = 270, minZ = 28.62, maxZ = 32.62},
    },
}
