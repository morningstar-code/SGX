local function CustomAlert(data)
    ...
    TriggerServerEvent('sgx-dispatch:server:notify', dispatchData)
end
...
RegisterNetEvent("sgx-dispatch:client:officerdown", function() OfficerDown() end)
...
RegisterNetEvent("sgx-dispatch:client:officerbackup", function() OfficerBackup() end)
...
RegisterNetEvent("sgx-dispatch:client:emsdown", function() EmsDown() end)
...
RegisterNetEvent('sgx-dispatch:client:sendEmergencyMsg', function(data, type, anonymous)
