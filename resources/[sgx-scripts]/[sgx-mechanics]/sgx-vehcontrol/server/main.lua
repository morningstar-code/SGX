...
if not LoadResourceFile(GetCurrentResourceName(), 'web/dist/index.html') then
    local err =
    'Unable to load UI. Build sgx-vehcontrol or download the latest release.\n https://github.com/vipexv/sgx-vehcontrol/releases/latest'

    print(err)
end

VersionCheck("vipexv/sgx-vehcontrol")