...
Config.DropItems = {
    ...
    combatpdw_scope = `w_at_scope_medium`,
      ...
      clean_card = `p_ld_id_card_002`,
        ...
        realestatetablet = `prop_cs_tablet_02`,
        ...
        weapon_glock19gen4 = `glock19gen4`,
          ...
          --Chopshop
          car_wheel = `prop_wheel_02`,
          car_door = `prop_car_door_01`,
          radiator = `imp_prop_impexp_radiator_01`,
          trunk = `imp_prop_impexp_trunk_01a`,
          weapon_digiscanner = `w_am_digiscanner`,

          --cash
          markedbills = `prop_money_bag_01`,
          cash = `prop_cash_case_01`,

          --drugs
          meth = `hei_prop_pill_bag_01`,
          --misc
          newspaper = `p_cs_newspaper_s`,
          --oxy
          oxypackage = `prop_cs_cardbox_01`,
          oxybox = `prop_cs_cardbox_01`,
          oxy = `prop_cs_pills`,
          --trap phone
          trapphone = `prop_prologue_phone_lod`,
