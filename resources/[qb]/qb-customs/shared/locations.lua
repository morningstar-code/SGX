--[[
    ...
    settings = {
        ...
        saveUpgrades = { 
            jobs = {"nil"}, -- If a player has some of these jobs, they will need to pay for every 
                                    -- modification, and all will be saved on the vehicle.
            dutyCheck = false, 
        } ,

        upgradesMenuAccess = {
            jobs = {"nil"}, -- If a player has some of these jobs, they will have access to the "upgrades menu" - engine upgrades, brake upgrades...
            dutyCheck = false,
        },
        ------------------------------------
    },
