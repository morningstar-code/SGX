...
QBCore.Commands.Add('removearmor', 'Resets Vest (Police Only)', {}, false, function(source)
...
RegisterNetEvent('consumables:server:RemoveParachuteItem', function()
    local src = source
...
QBCore.Commands.Add('repackparachute', 'Resets Parachute', {}, false, function(source)
