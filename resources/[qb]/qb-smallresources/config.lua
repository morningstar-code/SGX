...
Config.PauseMapText = 'SGX Core V1.5'                                     -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
...
Config.Discord = {
    ...
    applicationId = '1250712795629228053',                   -- The discord application id
    iconLarge = 'sgx_logo',                               -- The name of the large icon
    iconLargeHoverText = 'SGX', -- The hover text of the large icon
    iconSmall = 'xxxxxx',                         -- The name of the small icon
    iconSmallHoverText = 'sgxcore', -- The hover text of the small icon
    ...
    buttons = {
        ...
        {
            text = 'Youtube!',
            url = 'https://www.youtube.com/@sgxcore/featured'
        }
    }
}
