...
Config.PedCoords = vector4(-1006.984, -478.0069, 50.028209, 212.42341) -- Create preview ped at these coordinates
...
Config.PlayersNumberOfCharacters = { -- Define maximum amount of player characters by rockstar license (you can find this license in your server's database in the player table)
    { license = "license:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", numberOfChars = 4 },
}
