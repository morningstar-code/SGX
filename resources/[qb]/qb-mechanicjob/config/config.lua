...
Config.FuelResource = 'sgx-fuel'             -- supports any that has a GetFuel() and SetFuel() export
...
Config.Shops = {
    ...
    redlinemechanic = { -- Airport Location
    managed = true,
    shopLabel = 'LS Customs',
    showBlip = true,
    blipSprite = 72,
    blipColor = 46,
    blipCoords = vector3(-1616.28, -832.64, 10.07),
    shop = vector3(-1630.97, -817.12, 10.20),
    duty = vector3(-1631.42, -823.69, 10.00),
    stash = vector3(-1609.50, -841.70, 10.27),
    paint = vector3(-1626.94, -827.37, 10.07),
    vehicles = {
        withdraw = vector3(0, 0, 0),
        spawn = vector4(0, 0, 0, 0),
        list = { 'flatbed', 'towtruck', 'minivan', 'blista' }
    ...
    autoexotic = { -- Airport Location
    managed = true,
    shopLabel = 'Auto Exotic',
    showBlip = true,
    blipSprite = 72,
    blipColor = 46,
    blipCoords = vector3(548.51, -173.76, 54.51),
    shop = vector3(559.15, -171.78, 54.31),
    duty = vector3(560.40, -198.79, 54.40),
    stash = vector3(538.74, -165.73, 54.50),
    paint = vector3(560.68, -169.69, 54.51),
    vehicles = {
        withdraw = vector3(0, 0, 0),
        spawn = vector4(0, 0, 0, 0),
        list = { 'flatbed', 'towtruck', 'minivan', 'blista' }
    ...
    bennys = { -- Default Bennys Location
        managed = true,
        shopLabel = 'Benny\'s Orignal Motorworks',
        showBlip = false,
        blipSprite = 72,
        blipColor = 46,
    ...
    bennys2 = {
    managed = true,
    shopLabel = 'Benny\'s Vespucci BLVD Motorworks',
    showBlip = false,
    blipSprite = 72,
    blipColor = 46,
    blipCoords = vector3(947.55, -1028.82, 40.85),
    shop = vector3(956.35, -1045.50, 41.21),
    duty = vector3(945.52, -1050.55, 39.97),
    stash = vector3(944.65, -1054.51, 41.12),
    paint = vector3(935.39, -1032.63, 41.04),
    vehicles = {
        withdraw = vector3(0, 0, 0),
        spawn = vector4(0, 0, 0, 0),
        list = { 'flatbed', 'towtruck', 'minivan', 'blista' }
