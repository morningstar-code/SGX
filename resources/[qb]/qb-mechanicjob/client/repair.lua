...
local function RepairPart(vehicle, plate, component)
    ...
    ToggleHood(vehicle)
    QBCore.Functions.Progressbar('repairing_vehicle', string.format(Lang:t('progress.repairing'), componentLabel), 50000, false, true, {
...
RegisterNetEvent('qb-mechanicjob:client:repairVehicle', function()
    ...
    local bodyHealth = GetVehicleBodyHealth(vehicle)
    ToggleHood(vehicle)
    QBCore.Functions.Progressbar('repairing_vehicle', Lang:t('progress.repair_vehicle'), 25000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('qb-mechanicjob:client:repairVehicleFull', function()
    ...
    if not IsNearBone(vehicle, 'engine') then return end
    ToggleHood(vehicle)
    QBCore.Functions.Progressbar('repairing_vehicle', Lang:t('progress.repair_vehicle'), 50000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('qb-mechanicjob:client:repairTire', function()
    ...
    QBCore.Functions.Progressbar('repairing_tire', Lang:t('progress.repair_tire'), 20000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('qb-mechanicjob:client:cleanVehicle', function()
    local vehicle, distance = QBCore.Functions.GetClosestVehicle()
    if vehicle == 0 or distance > 5.0 then return end
    QBCore.Functions.Progressbar('cleaning_vehicle', Lang:t('progress.cleaning'), 15000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
