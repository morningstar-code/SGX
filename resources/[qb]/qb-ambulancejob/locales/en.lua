local Translations = {
    ...
    text = {
        pstash_button = '  Personal stash',
        pstash = 'Personal stash',
        onduty_button = '  Go On Duty',
        offduty_button = '  Go Off Duty',
        duty = 'On/Off Duty',
        armory_button = '  Armory',
        armory = 'Armory',
        veh_button = '  Grab / Store Vehicle',
        heli_button = '  Grab / Store Helicopter',
        elevator_roof = '  Take the elevator to the roof',
        elevator_main = '  Take the elevator down',
        bed_out = '  To get out of bed..',
        call_doc = '  Call doctor',
        call = 'Call',
        check_in = ' Check in',
        check = 'Check In',
        lie_bed = '  To lie in bed'
    },
    body = {
        head = 'Head',
        neck = 'Neck',
