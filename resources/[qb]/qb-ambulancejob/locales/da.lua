local Translations = {
    ...
    text = {
        pstash_button = ' - Personligt lager',
        pstash = 'Personligt lager',
        onduty_button = ' - Gå på vagt',
        offduty_button = ' - Gå af vagt',
        duty = 'På/Af Vagt',
        armory_button = ' - Lager',
        armory = 'Lager',
        veh_button = ' - Tag / Gem køretøj',
        heli_button = ' - Tag / Gem Helikopter',
        elevator_roof = ' - Tag elevatoren til taget',
        elevator_main = ' - Tag elevatoren ned',
        bed_out = ' - For at komme ud af sengen..',
        call_doc = ' - Ring til læge',
        call = 'Ring',
        check_in = ' Tjek ind',
        check = 'Tjek ind',
        lie_bed = ' - At ligge i sengen'
    },
    body = {
        head = 'Hoved',
        neck = 'hals',
