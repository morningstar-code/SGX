local Translations = {
    ...
    text = {
        pstash_button = ' - Esconderijo pessoal',
        pstash = 'Esconderijo pessoal',
        onduty_button = ' - Entrar em serviço',
        offduty_button = ' - Sair de serviço',
        duty = 'Entrar/Sair de serviço',
        armory_button = ' - Arsenal',
        armory = 'Arsenal',
        veh_button = ' - Retirar / Guardar Veículo',
        heli_button = ' - Retirar / Guardar Helicóptero',
        elevator_roof = ' - Pegue o elevador para o terraço',
        elevator_main = ' - Desça o elevador',
        bed_out = ' - Para sair da maca..',
        call_doc = ' - Ligue para o médico',
        call = 'Ligar',
        check_in = ' Check in',
        check = 'Check In',
        lie_bed = ' - Para deitar na maca'
    },
    body = {
        head = 'Cabeça',
        neck = 'Pescoço',
