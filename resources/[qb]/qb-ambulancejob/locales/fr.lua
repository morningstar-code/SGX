local Translations = {
    ...
    text = {
        pstash_button = ' - Coffre Personnel',
        pstash = 'Coffre personnel',
        onduty_button = ' - Prendre son service',
        offduty_button = ' - Quitter son service',
        duty = 'En/Hors Service',
        armory_button = ' - Armurerie',
        armory = 'Armurerie',
        veh_button = ' - Prendre / Ranger un vehicule',
        heli_button = ' - Prendre / Ranger un helicoptère',
        elevator_roof = ' - Prendre l\'ascenseur jusqu\'au toit',
        elevator_main = ' - Prendre l\'ascenseur',
        bed_out = ' - Pour sortir du lit..',
        call_doc = ' - Appeler un docteur',
        call = 'Appeler',
        check_in = ' - S\'hospitaliser',
        check = 'Enregistrement',
        lie_bed = ' - Pour s\'allonger dans un lit'
    },
    body = {
        head = 'Tête',
        neck = 'Nuque',
