local Translations = {
    ...
    text = {
        pstash_button = ' - Inventario Personale',
        pstash = 'Inventario Personale',
        onduty_button = ' - Vai in servizio',
        offduty_button = ' - Vai fuori servizio',
        duty = 'Entra/Esci dal Servizio',
        armory_button = ' - Farmacia',
        armory = 'Farmacia',
        veh_button = ' - Prendi / Deposita Veicolo',
        heli_button = ' - Prendi / Deposita Velivolo',
        elevator_roof = ' - Prendi l\'ascensore fino al tetto',
        elevator_main = ' - Prendi l\'ascensore fino al piano',
        bed_out = ' - Per alzarti dal letto..',
        call_doc = ' - Chiama un dottore',
        call = 'Chiama',
        check_in = ' Check in',
        check = 'Check In',
        lie_bed = ' - Sdraiarsi sul letto'
    },
    body = {
        head = 'Testa',
        neck = 'Collo',
