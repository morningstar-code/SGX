local Translations = {
    ...
    info = {
        ...
        respawn_revive = 'MANTÉN  DURANTE %{holdtime} SEGUNDOS PARA SER REVIVIDO POR $%{cost}',
    ...
    text = {
        pstash_button = ' - Stash personal',
        pstash = 'Stash personal',
        onduty_button = ' - Entrar en servicio',
        offduty_button = ' - Salir de servicio',
        duty = 'En/fuera de servicio',
        armory_button = ' - Armería',
        armory = 'Armería',
        veh_button = ' - Sacar / guardar vehículo',
        heli_button = ' - Sacar / guardar helicoptero',
        elevator_roof = ' - Tomar el elevador al último piso',
        elevator_main = ' - Tomar el elevador hacía abajo',
        bed_out = ' - Para salir de la cama..',
        call_doc = ' - Llamar doctor',
        call = 'Llamar',
        check_in = ' Hacer check-in',
        check = 'Check-in',
        lie_bed = ' - Para acostarse en la cama'
    },
    body = {
        head = 'cabeza',
        neck = 'cuello',
