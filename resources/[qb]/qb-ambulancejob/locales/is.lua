local Translations = {
    ...
    text = {
        pstash_button = ' - Persónulegt geymsla',
        pstash = 'Persónulegt geymsla',
        onduty_button = ' - Farðu á vakt',
        offduty_button = ' - Farðu af vakt',
        duty = 'Kveikt/slökkt Skylda',
        armory_button = ' - Vopnabúr',
        armory = 'Vopnabúr',
        veh_button = ' - Grípa / geyma farartæki',
        heli_button = ' - Grípa / geyma þyrla',
        elevator_roof = ' - Taktu lyftuna upp á þakið',
        elevator_main = ' - Taktu lyftuna niður',
        bed_out = ' - Til að fara fram úr rúminu..',
        call_doc = ' - Hringdu í lækni',
        call = 'Hringdu',
        check_in = ' Innritun',
        check = 'Innritun',
        lie_bed = ' - Að liggja í rúminu'
    },
    body = {
        head = 'Höfuð',
        neck = 'Háls',
