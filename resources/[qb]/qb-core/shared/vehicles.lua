...
local Vehicles = {
    ...
    -- Base Game Vehicles
    { model = 'blista',        name = 'Blista',                        brand = 'Dinka',           price = 13000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "D", }, -- Can either be D, C, B, A, A+, S, S+
    { model = 'brioso',        name = 'Brioso R/A',                    brand = 'Grotti',          price = 20000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "D", },
    { model = 'club',          name = 'Club',                          brand = 'BF',              price = 8000,    category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "C", }, 
    { model = 'dilettante',    name = 'Dilettante',                    brand = 'Karin',           price = 9000,    category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "C", }, 
    { model = 'dilettante2',   name = 'Dilettante Patrol',             brand = 'Karin',           price = 12000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "B", }, 
    { model = 'kanjo',         name = 'Blista Kanjo',                  brand = 'Dinka',           price = 12000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "B", }, 
    { model = 'issi2',         name = 'Issi',                          brand = 'Weeny',           price = 7000,    category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "A", }, 
    { model = 'issi3',         name = 'Issi Classic',                  brand = 'Weeny',           price = 5000,    category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "A", }, 
    { model = 'issi4',         name = 'Issi Arena',                    brand = 'Weeny',           price = 80000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "A+",}, 
    { model = 'issi5',         name = 'Issi Future Shock',             brand = 'Weeny',           price = 80000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "A+",}, 
    { model = 'issi6',         name = 'Issi Nightmare',                brand = 'Weeny',           price = 80000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "S", }, 
    { model = 'panto',         name = 'Panto',                         brand = 'Benefactor',      price = 3200,    category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "S", }, 
    { model = 'prairie',       name = 'Prairie',                       brand = 'Bollokan',        price = 30000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "S+",}, 
    { model = 'rhapsody',      name = 'Rhapsody',                      brand = 'Declasse',        price = 10000,   category = 'compacts',       type = 'automobile', shop = 'pdm', ["tier"] = "S+",},
    ...
    --ambulancejob
    { model = 'ambulance2',    name = 'MRSA Ambulance Small',                           brand = 'MRSA',        price = 100000,  category = 'openwheel',      type = 'automobile', shop = 'none' },
    { model = 'emsstalker',    name = 'MRSA Stalker',                           brand = 'MRSA',      price = 100000,  category = 'openwheel',      type = 'automobile', shop = 'none' },
    { model = 'emscomet',      name = 'MRSA Comet',                           brand = 'MRSA',          price = 100000,  category = 'openwheel',      type = 'automobile', shop = 'none' },
}
