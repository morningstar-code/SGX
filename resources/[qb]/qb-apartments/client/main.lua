...
exports['sgx-textui-2']:create3DTextUI("sgx-apartment0", {
    coords = vector3(-316.97, -1048.55, 31.04),
    displayDist = 6.0,
    interactDist = 1.0,
    ...
    triggerData = {
        triggerName = "apartments:client:EnterApartment",
        args = {}
    }
})

exports['sgx-textui-2']:create3DTextUI("sgx-apartment1", {
    coords = vector3(-325.75, -1047.44, 31.04),
    displayDist = 6.0,
    interactDist = 1.0,
    enableKeyClick = true, -- If true when you near it and click key it will trigger the event that you write inside triggerData
    keyNum = 38,
...
exports['sgx-textui-2']:create3DTextUI("sgx-apartment2", {
    coords = vector3(-318.30, -1052.20, 31.04),
    displayDist = 6.0,
    interactDist = 1.0,
    enableKeyClick = true, -- If true when you near it and click key it will trigger the event that you write inside triggerData
    keyNum = 38,
...
exports['sgx-textui-2']:create3DTextUI("sgx-apartment3", {
    coords = vector3(-319.70, -1055.90, 31.04),
    displayDist = 6.0,
    interactDist = 1.0,
    enableKeyClick = true, -- If true when you near it and click key it will trigger the event that you write inside triggerData
    keyNum = 38,
...
exports['sgx-textui-2']:create3DTextUI("sgx-apartment4", {
    coords = vector3(-327.05, -1051.17, 31.04),
    displayDist = 6.0,
    interactDist = 1.0,
    enableKeyClick = true, -- If true when you near it and click key it will trigger the event that you write inside triggerData
    keyNum = 38,
...
exports['sgx-textui-2']:create3DTextUI("sgx-apartment5", {
    coords = vector3(-328.40, -1054.86, 31.04),
    displayDist = 6.0,
    interactDist = 1.0,
    enableKeyClick = true, -- If true when you near it and click key it will trigger the event that you write inside triggerData
    keyNum = 38,
